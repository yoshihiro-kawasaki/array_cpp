...
public:
    ...
    inline T &operator() (const int i) { return pdata_[i]; }
    inline T operator() (const int i) const { return pdata_[i]; }
    ...
    void GetPdata(T *pdata) { pdata_ = pdata; }
...
public:
    ...
    inline T &operator() (const int i, const int j) { return pdata_[j + n2_*i]; }
    inline T operator() (const int i, const int j) const { return pdata_[j + n2_*i]; }
